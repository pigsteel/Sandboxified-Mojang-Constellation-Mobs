...
On Fabric, requires [Fabric API](https://modrinth.com/mod/fabric-api).

[Lithostitched](https://modrinth.com/mod/lithostitched) is recommended so that mobs can appear in trial chambers!

## Modpacks
Permission is granted! As long as you include this mod as modrinth metadata rather than a jar pls+thx. :D
