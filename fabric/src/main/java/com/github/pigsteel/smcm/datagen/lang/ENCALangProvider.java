...
public class ENCALangProvider extends FabricLanguageProvider {
    ...
    public ENCALangProvider(FabricPackOutput packOutput, CompletableFuture<HolderLookup.Provider> registryLookup) {
