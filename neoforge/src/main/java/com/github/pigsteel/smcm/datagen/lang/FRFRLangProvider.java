...
public class FRFRLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("subtitles.smcm.entity.reclaimed.ambient", "Grognement de " + JungleZombieNameS);
        ...
        add("subtitles.smcm.entity.enchanter.ambient", "Murmure d'" + EnchanterNameS);
