...
public class ReclaimedOuterLayer extends RenderLayer<ZombieRenderState, ReclaimedModel> {
    ...
    public ReclaimedOuterLayer(final RenderLayerParent<ZombieRenderState, ReclaimedModel> renderer, final EntityModelSet modelSet) {
        super(renderer);
