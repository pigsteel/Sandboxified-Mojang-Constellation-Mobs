...
public class GeomancerRenderer extends IllagerRenderer<Geomancer, GeomancerRenderState> {
    private static final ResourceLocation GEOMANCER_LOCATION = EUM.id("textures/entity/illager/geomancer.png");
    ...
    @Override
    public ResourceLocation getTextureLocation(GeomancerRenderState state) {
