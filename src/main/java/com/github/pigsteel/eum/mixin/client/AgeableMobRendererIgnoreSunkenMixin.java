...
import com.github.pigsteel.eum.client.renderer.entity.SunkenRenderer;
...
public abstract class AgeableMobRendererIgnoreSunkenMixin {
    ...
    private EntityModel<?> eum$useSunkenSelectedModel(
            EntityModel<?> original
    ) {
        if ((Object) this instanceof SunkenRenderer renderer) {
            return renderer.eum$getSelectedModel();
        }
