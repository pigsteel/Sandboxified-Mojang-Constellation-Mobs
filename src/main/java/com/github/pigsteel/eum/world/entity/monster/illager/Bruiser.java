...
public class Bruiser extends AbstractIllager {
    ...
    public SoundEvent getCelebrateSound() {
        return EUMSoundEvents.BRUISER_CELEBRATE.get();
    }

    @Override
    public SoundEvent getHurtSound(DamageSource source) {
        return EUMSoundEvents.BRUISER_HURT.get();
    }

    @Override
    public SoundEvent getDeathSound() {
        return EUMSoundEvents.BRUISER_DEATH.get();
    }

    @Override
    public SoundEvent getAmbientSound() {
        return EUMSoundEvents.BRUISER_AMBIENT.get();
    }
