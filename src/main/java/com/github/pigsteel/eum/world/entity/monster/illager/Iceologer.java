...
public class Iceologer extends AbstractIllager {
	...
	public SoundEvent getCelebrateSound() {
		return EUMSoundEvents.ICEOLOGER_CELEBRATE.get();
	}

	@Override
	protected SoundEvent getAmbientSound() {
		return EUMSoundEvents.ICEOLOGER_AMBIENT.get();
	}

	@Override
	protected SoundEvent getHurtSound(final DamageSource source) {
		return EUMSoundEvents.ICEOLOGER_HURT.get();
	}

	@Override
	protected SoundEvent getDeathSound() {
		return EUMSoundEvents.ICEOLOGER_DEATH.get();
	}
