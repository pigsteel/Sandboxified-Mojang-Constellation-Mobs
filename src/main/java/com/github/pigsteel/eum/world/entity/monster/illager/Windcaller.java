...
public class Windcaller extends AbstractIllager {
	...
	public SoundEvent getCelebrateSound() {
		return EUMSoundEvents.WINDCALLER_CELEBRATE.get();
	}

	@Override
	protected SoundEvent getAmbientSound() {
		return EUMSoundEvents.WINDCALLER_AMBIENT.get();
	}

	@Override
	protected SoundEvent getHurtSound(final DamageSource source) {
		return EUMSoundEvents.WINDCALLER_HURT.get();
	}

	@Override
	protected SoundEvent getDeathSound() {
		return EUMSoundEvents.WINDCALLER_DEATH.get();
	}
