package com.github.pigsteel.eum.world.entity.monster.redstonegolem;
...
public class RedstoneGolem extends Raider {
    ...
    public SoundEvent getAmbientSound() {
        return EUMSoundEvents.REDSTONE_GOLEM_AMBIENT.get();
    }

    @Override
    public SoundEvent getDeathSound() {
        return EUMSoundEvents.REDSTONE_GOLEM_DEATH.get();
    }
    ...
    public SoundEvent getStepSound() {
        return EUMSoundEvents.REDSTONE_GOLEM_STEP_LIGHT.get();
    }

    @Override
    public SoundEvent getHurtSound(DamageSource source) {
        return EUMSoundEvents.REDSTONE_GOLEM_HURT.get();
    }
}
