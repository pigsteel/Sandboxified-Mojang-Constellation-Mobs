...
public class Iceologer extends AbstractIllager {
	...
	public SoundEvent getCelebrateSound() {
		return SMCMSoundEvents.ICEOLOGER_CELEBRATE.get();
	}

	@Override
	protected SoundEvent getAmbientSound() {
		return SMCMSoundEvents.ICEOLOGER_AMBIENT.get();
	}

	@Override
	protected SoundEvent getHurtSound(final DamageSource source) {
		return SMCMSoundEvents.ICEOLOGER_HURT.get();
	}

	@Override
	protected SoundEvent getDeathSound() {
		return SMCMSoundEvents.ICEOLOGER_DEATH.get();
	}
