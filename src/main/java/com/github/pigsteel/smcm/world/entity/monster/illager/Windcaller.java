...
public class Windcaller extends AbstractIllager {
	...
	public SoundEvent getCelebrateSound() {
		return SMCMSoundEvents.WINDCALLER_CELEBRATE.get();
	}

	@Override
	protected SoundEvent getAmbientSound() {
		return SMCMSoundEvents.WINDCALLER_AMBIENT.get();
	}

	@Override
	protected SoundEvent getHurtSound(final DamageSource source) {
		return SMCMSoundEvents.WINDCALLER_HURT.get();
	}

	@Override
	protected SoundEvent getDeathSound() {
		return SMCMSoundEvents.WINDCALLER_DEATH.get();
	}
